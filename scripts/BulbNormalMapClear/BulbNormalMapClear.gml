...
function BulbNormalMapClear(_baseSpecular = 0) {
	static _u_fAlphaThreshold_Normal = shader_get_uniform(
		__shdBulbNormal,
		"u_fAlphaThreshold"
	);
	static _u_fAlphaThreshold_Specular = shader_get_uniform(
		__shdBulbSpecular,
		"u_fAlphaThreshold"
	);
	static _u_fAlphaThreshold_SpecularForce = shader_get_uniform(
		__shdBulbSpecularForce,
		"u_fAlphaThreshold"
	);
	...
	shader_set_uniform_f(
		_u_fAlphaThreshold_SpecularForce,
