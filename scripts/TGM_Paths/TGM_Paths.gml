...
function path_get_nearest_point(_x, _y, _path) {
	var i = 0,
		isize = path_get_number(_path),
		_px = 0,
		_py = 0,
		_dist = 0,
		_pri_x = ds_priority_create(),
		_pri_y = ds_priority_create();
	repeat (isize) {
	...
	var _pos = new Vector2(ds_priority_find_min(_pri_x), ds_priority_find_min(_pri_y));
