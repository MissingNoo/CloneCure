...
new achievement("BBBBRRRRRRRREEEEEE", sAchFirstBoss)
	.set_item("Gorilla_Paw")
	.on_enemy("Smol_Ame")
new achievement("Tears of Happiness...?", sAchTears)
	.set_weapon("CEO_Tears")
	.on_enemy("A-chan")
new achievement("You have been Cursed", sAchCursed)
	.set_money("EN_Curse")
	.on_enemy("Spiderchama")
...
new achievement("Speed Runner", sBlank)
	.set_money(2000)
...
new achievement("Idol Group", sBlank)
	.set_money(10000)
	.unlock_event("character_unlock", function() {
...
new achievement("Power of Idols", sBlank)
	.set_item("Idol Costume")
	.unlock_event("special", function() {
		unlock();
	})
new achievement("Hai...", sBlank)
	.set_money(100)
	.unlock_event("prop_destroyed", function(name) {
		if (name == "yagoo_statue") {
			unlock();
		}
	})
new achievement("Time To Upgrade", sBlank)
	.set_item("Credit Card")
	.unlock_event("anvil", function() {
		unlock();
	})
new achievement("Boing", sBlank)
	.set_weapon("Bounce Ball")
	.unlock_event("time_minute", function(minute) {
		if (minute == 10 && player_have_item("Cutting_Board") && oPlayer.char.flat) {
			unlock();
		}
	})
new achievement("It's Safe I Swear", sBlank)
	.set_weapon("Injection Type Asacoco")
	.unlock_event("get_money", function() {
		if (player_have_item("Plug_Type_Asacoco")) {
			unlock();
		}
	})
new achievement("It's Super Chat Time", sBlank)
	.set_item("Super Chatto Time")
	.unlock_event("get_money", function() {
		if (SaveData.money > 5000) {
			unlock();
		}
	})
new achievement("The Real Grind", sBlank)
	.set_money(10000)
	.unlock_event("stage_clear", function() {
...
new achievement("Wamy.", sBlank)
	.set_weapon("Wamy Water")
	.unlock_event("stage_clear", function() {
		if (player_have_item("sake")) {
			unlock();
		}
	})
new achievement("Decked Out", sBlank)
	.set_item("Study Glasses")
	.unlock_event("level_up", function(level) {
		if (level == 50) {
			unlock();
		}
	})
new achievement("Glasses are Versatile", sBlank)
	.set_money(2000)
	.unlock_event("level_up", function(level) {
		if (level == 100) {
			unlock();
...
new achievement("Delusional", sBlank)
	.set_item("Halu")
	.unlock_event("enemy_defeated", function() {
		if (GameData.kills >= 5000) {
			unlock();
		}
	})
new achievement("Went Too Halu", sBlank)
	.set_item("GWS Pill")
...
new achievement("Hamburger Country Yeah!", sBlank)
	.set_money(500)
	.unlock_event("ate_food", function() {
		if (GameData.burguers >= 50) {
			unlock();
		}
	})
new achievement("Thousand Milestone!", sBlank)
	.set_item("Devil Hat")
	.unlock_event("damage_dealt", function(dmg) {
		if (dmg >= 1000) {
			unlock();
		}
	})
new achievement("Over Nine Thousand?!", sBlank)
	.set_money(2000)
	.unlock_event("damage_dealt", function(dmg) {
		if (dmg >= 10000) {
			unlock();
...
new achievement("Flesh Wound", sBlank)
	...
	.unlock_event("died", function(dmg) {
		if (global.minutes >= 10) {
			unlock();
		}
	})
new achievement("I don't need it", sBlank)
	.set_money(1000)
	.unlock_event("stage_clear", function() {
		if (!GameData.used_special && shop_level("Special_Attack") == 1) {
			unlock();
		}
	})
...
new achievement("Sorry", sBlank)
	.set_character("Ninomae Ina'nis")
	.set_weapon("Cutting Board")
...
new achievement("Chicken Down", sBlank)
	.set_character("Takanashi Kiara")
	.set_item("Chicken's Feather")
...
new achievement("I Like the Cotton Candy Flavor", sBlank)
	.set_character("Mori Calliope")
	.set_item("Energy Drink")
...
new achievement("That's not Dollrys", sBlank)
	.set_character("Hakos Baelz")
	.set_item("Plushie")
...
new achievement("Uuuuuuuuuuuuuuuuuuuuuuuuuuuu", sBlank)
	.set_character("Ceres Fauna")
	.set_money(500)
...
new achievement("Limiters Released!", sBlank)
	.set_character("Tsukumo Sana")
	.set_item("Limiter")
...
new achievement("Kon Kon Kitsune!", sBlank)
	.set_character("Shirakami Fubuki")
	.set_money(500)
...
new achievement("Mogu Mogu... Okayu!", sBlank)
	.set_character("Nekomata Okayu")
	.set_money(500)
new achievement("True Onigiriya", sBlank).set_character("Nekomata Okayu").set_money(3000)
new achievement("Hey Guys~", sBlank)
	.set_character("Inugami Korone")
	.set_weapon("X-Potato")
...
new achievement("Cute today too!", sBlank)
	.set_character("Hoshimachi Suisei")
	.set_money(500)
new achievement("True Hoshiyomi", sBlank)
	.set_character("Hoshimachi Suisei")
	.set_money(3000)
...
new achievement("Wasshoi! Wasshoi!", sBlank)
	.set_character("Natsuiro Matsuri")
	.set_money(500)
new achievement("True Matsurisu", sBlank)
	.set_character("Natsuiro Matsuri")
	.set_money(3000)
...
new achievement("Kusogaki Power", sBlank)
	.set_character("Murasaki Shion")
	.set_item("Kusogaki Shackles")
new achievement("Neeeeeeeeeeeeeeeeeeeeee~", sBlank)
	.set_character("Murasaki Shion")
	.set_money(500)
...
new achievement("Moon Moon~ Moonafic Dayo!", sBlank)
	.set_character("Moona Hoshinova")
	.set_money(500)
...
new achievement("Purupuru ganbari Risu~!", sBlank)
	.set_character("Ayunda Risu")
	.set_money(500)
...
new achievement("Otsucrazy!", sBlank)
	.set_character("Kureiji Ollie")
	.set_item("Ninja Headband")
...
new achievement("I am under the water", sBlank)
	.set_character("Kobo Kanaeru")
	.set_money(500)
...
new achievement("A Little Trollin", sBlank)
	.set_character("Vestia Zeta")
	.set_item("Focus Shades")
...
new achievement("Konpeko! Konpeko! Konpeko!", sBlank)
	.set_character("Usada Pekora")
	.set_money(500)
...
new achievement("True Tokoyami Kenzoku", sBlank)
	.set_character("Tokoyami Towa")
	.set_money(3000)
new achievement("Otsukaresama Nanora Ne", sBlank)
	.set_character("Himemori Luna")
	.set_money(500)
