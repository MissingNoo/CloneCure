function __BulbAddOcclusionSoft(_vbuff) {
	...
	repeat (array_length(_vertexArray) div 6) {
		...
		vertex_position_3d(_vbuff, _newAx, _newAy, 0);
		vertex_normal(_vbuff, _newDx, _newDy, 0);
		vertex_texcoord(_vbuff, 1, 1);
		vertex_position_3d(_vbuff, _newBx, _newBy, __BULB_ZFAR);
		vertex_normal(_vbuff, _newDx, _newDy, 0);
		vertex_texcoord(_vbuff, 1, 1);
		vertex_position_3d(_vbuff, _newBx, _newBy, 0);
		vertex_normal(_vbuff, _newDx, _newDy, 0);
		vertex_texcoord(_vbuff, 1, 1);
		...
		vertex_normal(_vbuff, _newDx, _newDy, 0);
		vertex_texcoord(_vbuff, 1, 1);
		vertex_position_3d(_vbuff, _newAx, _newAy, __BULB_ZFAR);
		vertex_normal(_vbuff, _newDx, _newDy, 0);
		vertex_texcoord(_vbuff, 1, 1);
		vertex_position_3d(_vbuff, _newBx, _newBy, __BULB_ZFAR);
		vertex_normal(_vbuff, _newDx, _newDy, 0);
		...
		vertex_position_3d(_vbuff, _newAx, _newAy, __BULB_ZFAR);
		vertex_normal(_vbuff, _newDx, _newDy, 1);
