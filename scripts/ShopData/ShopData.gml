...
function shop_ability(_name, _sprite, _cost) : shop_upgrade(
	_name,
	_sprite,
	_cost
) constructor {
...
function shop_stat(_name, _sprite, _cost) : shop_upgrade(
	_name,
	_sprite,
	_cost
) constructor {
...
function shop_other(_name, _sprite, _cost) : shop_upgrade(
	_name,
	_sprite,
	_cost
) constructor {
...
new shop_stat(
	"Max_HP_Up",
	sHudHPIcon,
	[200, 500, 1200, 2750, 6000, 12000, 18000, 24000, 30000, 36000]
)
new shop_stat(
	"ATK_Up",
	sHudATKIcon,
	[300, 750, 1800, 4100, 9100, 18000, 25000, 31000, 37000, 43000]
)
new shop_stat(
	"SPD_Up",
	sHudSPDIcon,
...
new shop_stat(
	"Special_Cooldown_Reduction",
	sHudSpecialCooldownIcon,
	[500, 1250, 3000, 6900, 15000]
)
new shop_stat(
	"Skill_Up",
	sHudHPIcon,
	[500, 1250, 3000, 6900, 15000, 20000, 30000, 40000, 50000, 60000]
) //TODO: icon
...
new shop_stat(
	"Money_Gain_Up",
	sHolocoin,
	[400, 1000, 2400, 5500, 12000, 20000, 30000, 40000, 50000, 60000]
)
