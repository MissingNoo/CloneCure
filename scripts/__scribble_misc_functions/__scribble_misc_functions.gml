...
function __scribble_random() {
	...
	_lcg = (48271 * _lcg) % 2147483647; //Lehmer
...
function __scribble_image_speed_get(_sprite) {
	return (sprite_get_speed_type(_sprite) == spritespeed_framespergameframe)
		? sprite_get_speed(_sprite)
		: (sprite_get_speed(_sprite) / game_get_speed(gamespeed_fps));
}
...
function __scribble_matrix_inverse(_matrix) {
	...
	_inv[@ 0] =
		_matrix[5] * _matrix[10] * _matrix[15]
	...
	_inv[@ 4] =
		-_matrix[4] * _matrix[10] * _matrix[15]
	...
	_inv[@ 8] =
		_matrix[4] * _matrix[9] * _matrix[15]
	...
	_inv[@ 12] =
		-_matrix[4] * _matrix[9] * _matrix[14]
	...
	_inv[@ 1] =
		-_matrix[1] * _matrix[10] * _matrix[15]
	...
	_inv[@ 5] =
		_matrix[0] * _matrix[10] * _matrix[15]
	...
	_inv[@ 9] =
		-_matrix[0] * _matrix[9] * _matrix[15]
	...
	_inv[@ 13] =
		_matrix[0] * _matrix[9] * _matrix[14]
	...
	_inv[@ 2] =
		_matrix[1] * _matrix[6] * _matrix[15]
	...
	_inv[@ 6] =
		-_matrix[0] * _matrix[6] * _matrix[15]
	...
	_inv[@ 10] =
		_matrix[0] * _matrix[5] * _matrix[15]
	...
	_inv[@ 14] =
		-_matrix[0] * _matrix[5] * _matrix[14]
	...
	_inv[@ 3] =
		-_matrix[1] * _matrix[6] * _matrix[11]
	...
	_inv[@ 7] =
		_matrix[0] * _matrix[6] * _matrix[11]
	...
	_inv[@ 11] =
		-_matrix[0] * _matrix[5] * _matrix[11]
	...
	_inv[@ 15] =
		_matrix[0] * _matrix[5] * _matrix[10]
