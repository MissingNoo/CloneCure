...
function __ScribblejrClassBakerFit(
	_string,
	_font,
	_hAlign,
	_vAlign,
	...
	vertex_float2(__vertexBuffer, 0, 0);
	vertex_texcoord(__vertexBuffer, 0, 0);
	vertex_float2(__vertexBuffer, 0, 0);
	vertex_texcoord(__vertexBuffer, 0, 0);
	vertex_float2(__vertexBuffer, 0, 0);
	vertex_texcoord(__vertexBuffer, 0, 0);
	...
	static __Freeze = function() {
		if (
			(_system.__budget - _system.__budgetUsed > 500) || (_system.__budgetUsed == 0)
		) {
