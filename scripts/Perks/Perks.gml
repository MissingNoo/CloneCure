...
i.before_hit = method(i, function() {
	...
	if (LastProj.wid.type == weapon_type.Multishot or LastProj.wid.type == weapon_type.Ranged) {
...
i.before_hit = method(i, function() {
	var rnd = irandom(100);
	if (level == 3 and rnd <= 2 and instance_exists(global.lastenemy) and !global.lastenemy.boss) {
