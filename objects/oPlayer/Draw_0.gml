...
if (GameData.hp > 0 and GameData.hp < GameData.max_hp) {
    draw_healthbar((x - 13), ((y - sprite_height) - 3), (x + 13), ((y - sprite_height) - 6), ((GameData.hp / GameData.max_hp) * 100), c_red, c_lime, c_lime, 0, 1, 0);
}
if (GameData.shield > 0 and GameData.hp > 0) {
    draw_healthbar((x - 13), ((y - 19) - 20), (x + 13), ((y - 19) - 23), ((GameData.shield / GameData.max_shield) * 100), c_red, c_blue, c_blue, 0, 1, 0);
}
