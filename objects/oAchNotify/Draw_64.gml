...
draw_sprite_ext(ach.sprite, 0, _x - icon_x, _y - icon_y, icon_scale, icon_scale, 0, c_white, 1);
draw_sprite_ext(sItemSquare, 0, _x - icon_x, _y - icon_y, border_scale, border_scale, 0, c_white, 1);
